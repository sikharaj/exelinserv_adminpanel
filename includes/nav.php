<!-- Left Sidebar Menu -->
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a class="" href="javascript:void(0);" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class="zmdi zmdi-car"></i><span class="right-nav-text">Service Reports</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="dashboard_dr" class="collapse collapse-level-1">
						<li>
							<a class="active-page" href="pending-bookings.php">Pending bookings</a>
						</li>
						<li>
							<a href="active-bookings.php">Active Bookings</a>
						</li>
						<li>
							<a href="current-bookings.php">Current Bookings</a>
						</li>
						<li>
				...
				<li>
					...
					<ul id="ecom_dr" class="collapse collapse-level-1">
						...
						<li>
							<a href="customer-vehicles.php">Customer Vehicles</a>
						</li>
						<li>
				...
				<li>
					...
					<ul id="app_dr" class="collapse collapse-level-1">
						...
						<li>
							<a href="inventory-details.php">Inventory Details</a>
						</li>
						<li>
							<a href="delivery-boy-details.php">Delivery Boy Details</a>
						</li>
					</ul>
				</li>
				<li>
