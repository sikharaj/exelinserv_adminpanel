...
if(!isset($_SESSION['bazooka'])) { // if session not set
   ...
   $selectAllQuickOrders = "SELECT * FROM `quickorder`";
		...
		<div class="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  ?>
													<tr>
                            <td><?=$selectAllQuickOrdersData['quikOrderID'];?></td>
                            <td><?=$selectAllQuickOrdersData['name'];?></td>
                            <td><?=$selectAllQuickOrdersData['vehicleName'];?></td>
                            <td><?=$selectAllQuickOrdersData['createdOn'];?></td>
                            <td><?=$selectAllQuickOrdersData['status'];?></td>
                            <td><?=$selectAllQuickOrdersData['issue'];?></td>
                            <td><?=$selectAllQuickOrdersData['phone'];?></td>
                          <td><?=$selectAllQuickOrdersData['serviceType'];?></td>
                            <td><a href="create_contract.php?quickOrderId=<?=$selectAllQuickOrdersData['quikOrderID'];?>"><button type="button" name="add" id="add" class="btn btn-success">Create Contract</button></a></td>
                          </tr>
                          <?php
                      }
